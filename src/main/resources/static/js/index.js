...
const editIds = ['nombreEditar', 'descripcionEditar', 'prioridadEditar', 'estatusEditar', 'eliminado'];
var campos = {
  nombre: 'nombre',
...
$(document).ready(function () {
  ...
  $('#table_tareas').on('click', '.btn-edit', function () {
    ...
    id = data.id;
    const newData = {
      nombreEditar: data.nombre, descripcionEditar: data.descripcion, prioridadEditar: data.prioridad, estatusEditar: data.estatus, activo: data.activo
    }
